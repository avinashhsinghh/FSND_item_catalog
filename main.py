...
# Read Google client_secrets.json and assign client_id to a variable for later use.
...
def fbconnect():
    ...
    """The token must be stored in the login_session in order to properly logout, let's strip out the information before the
